...
function renderMovers(rows, index) {
  ...
  if (note) {
    const base = hasPoints
      ...
      : `Every board symbol, ranked by impact share of total market movement — highest first, whichever direction. Official NEPSE point figure wasn't available this refresh.`;
